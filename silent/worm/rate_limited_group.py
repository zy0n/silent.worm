...
class LimitedGroupChatManager(ConversableAgent):
    """(In preview) A chat manager agent that can manage a group chat of multiple agents."""

    def __init__(
        self,
        groupchat: LimitedGroupChat,
        ...
        **kwargs,
        ...
        self.register_reply(
            Agent,
            LimitedGroupChatManager.run_chat,
            config=groupchat,
            reset_config=LimitedGroupChat.reset,
        )
    ...
    def run_chat(
        ...
        config: Optional[LimitedGroupChat] = None,
    ) -> Union[str, Dict, None]:
        """Run a group chat."""
        if messages is None:
