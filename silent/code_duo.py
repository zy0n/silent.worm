...
def spawn_task_expert(task):
    ...
    spawn_user = autogen.UserProxyAgent(
        ...
        code_execution_config={
            ...
            "use_docker": False,
            "last_n_messages": 10,  # how many blocks to execute?
        },
        default_auto_reply="Work by yourself, the user won't reply until you output `TERMINATE` to end the conversation.",
    )
